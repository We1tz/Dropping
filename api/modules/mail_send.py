...
def send_code_mail(data):
    ...
    subject = 'Foxproof | Письмо подтверждения'

    body = (f"""Здравствуйте, это Ваше письмо подтверждения почты.
...
def send_password_mail(data):
    ...
    body = (f"""Здравствуйте, это Ваше письмо с новым паролем на сайте.

        Ваш новый пароль для входа в аккаунт: {password}
